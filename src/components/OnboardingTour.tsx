  ...
  const steps: Step[] = [
    {
      ...
      content: 'Нейросеть автоматически нашла стены или фасады. Кликните на выделенную область, чтобы выбрать её для покраски.',
      placement: 'center',
    },
    {
      target: '.tour-walls-list',
      content: 'Здесь список всех поверхностей. Вы можете выбирать стены для работы, а также скрывать их с помощью иконки "глазика", если маска мешает обзору.',
      placement: 'right',
    },
    {
      target: '.tour-add-mask',
      content: 'Если нейросеть пропустила часть стены, нажмите сюда и поставьте 4 точки на фото, чтобы создать новую маску вручную.',
      placement: 'right',
    },
    {
      target: '.tour-materials-panel',
      content: 'Выберите фактуру (например, имитацию бруса) и желаемый оттенок краски. Цвет автоматически подстроится под освещение на фото.',
      placement: 'left',
    },
    {
      target: '.tour-apply-texture',
      content: 'Выделив стену и настроив материал, нажмите "Применить текстуру", чтобы примерить обшивку.',
      placement: 'bottom',
    },
    {
      target: '.tour-edit-mask',
      content: 'Если материал лег неровно, нажмите сюда. Вы сможете потянуть за углы маски, чтобы исправить перспективу, а в режиме "Форма" — подкорректировать точное заполнение границ.',
      placement: 'bottom',
    },
  ]
